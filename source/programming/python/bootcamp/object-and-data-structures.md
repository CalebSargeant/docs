...
## Summary
  ...
  Strings                 str                     Ordered sequence of characters:
                                                  `"hello" ' Caleb' "awe" '2020'`

  Lists                   list                    Ordered sequence of objects: [
                                                  ]{.title-ref}\[10,"hello",200.3\]\`\`

  Dictionaries            dict                    Unordered Key:Value pairs:
                                                  `{"mykey":"val ue","name","Caleb"}`
  ...
  Booleans                bool                    Logical value indicating `True` or
                                                  `False`
  -----------------------------------------------------------------------------------------
...
-   Often you will want to "inject a variable into your string for
    printing. For example:

    -   [my_name = "Caleb"]{.title-ref}
    -   [print("Hello " + my_name)]{.title-ref}
...
-   Two methods for this:
    ...
    > -   [.format()]{.title-ref} method
    > -   [f-strings]{.title-ref} (formatted string literals)
...
-   Dictionaries are unordered mappings for sorting objects. Previously
    we saw how lists store objects in an ordered sequence, dictionaries
...
-   Dictionaries use curly braces and colons to signify the keys and
    their associated values.

    > -   [{'key1':'value1','key2':'value2']{.title-ref}
...
-   mode='w+' is writing and reading (overwrites existing files or
    creates a new file)
