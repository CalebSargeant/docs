...
`_docs/redistribution-basic-configuration.zip`{.interpreted-text
role="download"}

![image](_images/redistribution-basic-configuration.png){.align-center
width="744px" height="206px"}
...
`_docs/redistribution-advanced-configuration.zip`{.interpreted-text
role="download"}

![image](_images/redistribution-advanced-configuration.png){.align-center
width="562px" height="447px"}
