...
-   Potential future features: IPSec everywhere, mobility, simpler
    header

### IPv6 Addressing

-   Address size moved from 32-bit (IPv4) to 128-bit (IPv6)
-   Provides 340,282,366,920,138,463,463,374,607,431,770,000,000
    addresses
-   To make addresses more manageable, divided into 8 groups of 4 hex
    characters each: `2001:0050:0000:0000:0000:0AB4:1E2B:98AA`
...
-   Always begins with `fe80` (first 10 bits: `1111 1110 10`) followed
    by 54 bits of zeros
-   Last 64 bits is the 48-bit mac address with `FFFE` squeezed in the
    middle
...
-   Subnet ID is comprised of whatever bits are left over after global
    routing prefix
-   The primary addresses expected to comprise the ipv6 internet are
    from the `2001::/16` subnet
