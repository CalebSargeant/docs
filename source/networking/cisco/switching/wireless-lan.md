...
-   The Service Set Identifier (SSID) uniquely identifies and seperates
    wireless networks
...
-   As more mobile devices are released, client roaming becomes a big
    deal
...
-   RF waves are absorbed (passing through walls) or reflected (by
    metal)
...
-   Lightweight Access Point Protocol (LWAPP) used between controller
    and WAPs
...
-   Omni-Directional Antenna: Provides even spread of wireless signal in
    a radius around the access point
-   Directional Antenna: Allows you to point antennas to get more radius
    and range in a specific direction
-   Yagi Antenna: Provides dual adjustments of direction and focus. The
    more streamlined focus gets intense reach/range.
