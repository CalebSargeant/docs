...
-   SNMP Views
    -   Defines the information that the SNMP user can access
        ...
        -   Object Identifiers (OID) correspond to specific information
            about a router
        -   OIDs are stored in a hierarchical tree. OIDs lower in the
            tree are included with OIDs above it

<figure>
<img
src="_images/configuring-management-protocols-on-a-cisco-ios-device-1.png"
alt="_images/configuring-management-protocols-on-a-cisco-ios-device-1.png" />
<figcaption>SNMP Configuration on Cisco Prime</figcaption>
</figure>
...
<figure>
<img
src="_images/configuring-management-protocols-on-a-cisco-ios-device-2.png"
alt="_images/configuring-management-protocols-on-a-cisco-ios-device-2.png" />
<figcaption>Syncronization Complete</figcaption>
</figure>
...
host \[\]? 172.20.1.15 Destination username \[caleb\]? Destination
filename \[globo-hq-confg\]? Writing globo-hq-confg Password:
