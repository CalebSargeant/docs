...
-   Manually configure bridge priority
    -   Root primary command will only decrement switch to be the root
        of the current switches in the spanning tree
...
-   Attacker could spoof MAC
    -   Switch would update CAM table with attackers port, and send
        future packets to it
