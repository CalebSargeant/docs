...
`https://github.com/CalebSargeant/Getting-Started-Terraform/blob/master/m7/variables.tf`{.interpreted-text
role="download"}

`https://github.com/CalebSargeant/Getting-Started-Terraform/blob/master/m7/terraform.tfvars.example`{.interpreted-text
role="download"}
