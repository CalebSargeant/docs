...
`https://github.com/CalebSargeant/Getting-Started-Terraform/blob/master/m3/module_three.tf`{.interpreted-text
role="download"}

## Working with Variables

`https://github.com/CalebSargeant/Getting-Started-Terraform/blob/master/m3/terraform.tfvars.example`{.interpreted-text
role="download"}
