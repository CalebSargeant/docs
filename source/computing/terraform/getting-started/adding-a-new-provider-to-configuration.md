...
`https://github.com/CalebSargeant/Getting-Started-Terraform/blob/master/m6/m6_commands.txt`{.interpreted-text
role="download"}

`https://github.com/CalebSargeant/Getting-Started-Terraform/blob/master/m6/modulesix.tf`{.interpreted-text
role="download"}
