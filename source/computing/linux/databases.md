...
The file must be in .sql format. It can not be compressed in a .zip or
.tar.gz file.
...
Temporary files are created in [base/pgsql_tmp]{.title-ref}. Rebooting
psql forces the clearing of tmp files by restarting the cleanup query.
