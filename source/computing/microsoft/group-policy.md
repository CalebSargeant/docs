...
5.  Add `C:\bginfo\name.bgi /SILENT /TIMER:0 /NOCLIENTPROMPT` to the
    argument field in the shortcut property in Group Policy Management.

## Disable Sound

Under *Computer Configuration*, under *Policies*, under *Administrative
...
Under *Computer Configuration*, under *Preferences*, under *Windows
Settings*, under *Shortcuts*, do the following:
...
Under *User Configuration*, under *Preferences*, under *Windows
Settings*, under *Drive Maps*, do the following:
