...
`Download Slides<_docs/AWS Certified Cloud Practitioner Slides v2.11.0.pdf>`{.interpreted-text
role="download"}
...
`Download Slides<_docs/AWS Certified SysOps Slides v3.8.0.pdf>`{.interpreted-text
role="download"}
