...
![lacp windows server](_images/lacp-windows-server-1.png)

Select the adapters, add to team

![lacp windows server](_images/lacp-windows-server-2.png)

For teaming mode choose LACP, load balancing method use address hash

![lacp windows server](_images/lacp-windows-server-3.png)
