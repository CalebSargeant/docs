...
Please note that you wont see any files on the server, because it is a bare repository and therefore the files are protected. You can create a Git Hook to expose the bare repository's files in a different directory (useful for web code). Use git clone <ssh://>\<hostname\>/path/to/gits to clone an existing server repository.
...
![google authenticator](_images/google-authenticator-1.png)

- Select the MFA Group.

![google authenticator](_images/google-authenticator-2.png)
...
![google authenticator](_images/google-authenticator-3.png)

![google authenticator](_images/google-authenticator-4.png)

- You will be connected to the VPN as per normal.

![google authenticator](_images/google-authenticator-5.png)
