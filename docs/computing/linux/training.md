...
![linux file system structure](_images/linux-file-system-structure.png)
...
![linux directory listing attributes](_images/linux-directory-listing-attributes.png)
...
![linux soft and hard links](_images/linux-soft-and-hard-links.png)
...
![linux file system permissions](_images/linux-file-system-permissions.png)
...
![linux file system permissions](_images/linux-file-system-permissions-2.png)
...
![linux vi vs vim](_images/linux-vi-vs-vim.png)
...
![15 uptime](https://raw.githubusercontent.com/CalebSargeant/docs/master/docs/computing/linux/_docs/training/module5/15-uptime.jpg)
...
![linux crontab](_images/linux-crontab-1.png)
...
![linux special permissions](_images/linux-special-permissions.png)
...
![linux kernel](_images/linux-kernel.png)
...
![Depreciated+Linux+commands+and+replacement](https://raw.githubusercontent.com/CalebSargeant/docs/master/docs/computing/linux/_docs/training/module7/Depreciated+Linux+commands+and+replacement.JPG)
...
![linux firewall](_images/linux-firewall.png)
...
![linux firewall](_images/linux-firewall-2.png)
...
![linux tuned](_images/linux-tuned.png)
...
![linux tuned](_images/linux-tuned-2.png)
...
![linux dhcp](_images/linux-dhcp.png)
...
![linux boot process](_images/linux-boot-process.png)
...
![linux boot process](_images/linux-boot-process-2.png)
...
![linux lvm](_images/linux-lvm.png)

![linux lvm](_images/linux-lvm-2.png)
...
![linux stratis](_images/linux-stratis.png)
...
![linux raid](_images/linux-raid.png)
...
![linux nfs](_images/linux-nfs.png)
