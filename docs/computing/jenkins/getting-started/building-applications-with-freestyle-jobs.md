...
<figcaption>Input the repo url, ensure branch is correct (main vs master)</figcaption>
</figure>
...
<figcaption>You can use <code>mvnw</code> commands for building</figcaption>
</figure>

<figure>
![jenkins](_images/jenkins-10.png)
<figcaption>We'll want to package our app, also exclude <code>*.jar</code> from being deleted</figcaption>
</figure>

<figure>
![jenkins](_images/jenkins-11.png)
<figcaption>You can configure test reports from the xml files</figcaption>
</figure>
...
<figcaption>Configuring polling git for changes to code to build automatically</figcaption>
</figure>

<figure>
![jenkins](_images/jenkins-14.png)
<figcaption>You can check the recent changes of a build and drill down into git diffs</figcaption>
</figure>
