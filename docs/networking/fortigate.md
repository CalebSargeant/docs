...
![fortigate site to site vpn](_images/fortigate-site-to-site-vpn-1.png)

1.  Create the tunnel.

![fortigate site to site vpn](_images/fortigate-site-to-site-vpn-2.png)
...
![fortigate site to site vpn](_images/fortigate-site-to-site-vpn-3.png)

3.  Create the objects for the destination range(s).

![fortigate site to site vpn](_images/fortigate-site-to-site-vpn-4.png)
...
![fortigate site to site vpn](_images/fortigate-site-to-site-vpn-5.png)
...
![fortigate site to site vpn](_images/fortigate-site-to-site-vpn-6.png)

6.  Create the policy.

![fortigate site to site vpn](_images/fortigate-site-to-site-vpn-7.png)
