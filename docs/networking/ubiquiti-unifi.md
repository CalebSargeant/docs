...
1.  Make sure the AP is running the same firmware as the controller. If it is not, see this guide: [Changing UniFi firmware via SSH](http://community.ubnt.com/t5/UniFi-Troubleshooting/UniFi-Upgrading-firmware-image-via-SSH/ta-p/944337). This is not required for minor version differences.
...
![unifi backup](_images/unifi-backup-1.png)
