...
- An incident handling guide by NIST: [view here](https://raw.githubusercontent.com/CalebSargeant/docs/master/docs/networking/cisco/core-security/fundamentals-from-the-book/_docs/NIST.SP.800-61r2.pdf) / [view online](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-61r2.pdf)
...
![security fundamentals forensics](_images/security-fundamentals-forensics-1.png)
