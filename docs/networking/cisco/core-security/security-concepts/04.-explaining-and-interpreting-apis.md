...
<figcaption>Authorization header (notice the URL of API call)</figcaption>
</figure>
...
<figcaption>We did a get to list our devices (notice the URL of API call)</figcaption>
</figure>
...
<figcaption>In Firepower, you'll see no objects, let's add one</figcaption>
</figure>
