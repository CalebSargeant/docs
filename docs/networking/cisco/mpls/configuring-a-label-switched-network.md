...
![mpls](_images/mpls-8.png)

[configure-a-label-switched-network.zip](https://raw.githubusercontent.com/CalebSargeant/docs/master/docs/networking/cisco/mpls/_files/configure-a-label-switched-network.zip)
