...
![bgp understanding ibgp vs ebgp](_images/bgp-understanding-ibgp-vs-ebgp.png)
...
[bgp-configuration.zip](https://raw.githubusercontent.com/CalebSargeant/docs/master/docs/networking/cisco/routing/_docs/bgp-configuration.zip)

![bgp configuration](_images/bgp-configuration.png)
...
[bgp-configuration-and-tuning.zip](https://raw.githubusercontent.com/CalebSargeant/docs/master/docs/networking/cisco/routing/_docs/bgp-configuration-and-tuning.zip)
