...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-1.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-2.png)

FTD in transparent mode:

![networking with firewall capabilities](_images/networking-with-firewall-capabilities-3.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-4.png)

FTD interface modes:

![networking with firewall capabilities](_images/networking-with-firewall-capabilities-5.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-6.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-7.png)

Traffic between a routed (L3) interface and a BVI:

![networking with firewall capabilities](_images/networking-with-firewall-capabilities-8.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-9.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-10.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-11.png)
...
![networking with firewall capabilities](_images/networking-with-firewall-capabilities-12.png)

### Cisco FTD Deployment Design Configurations

| Design Consideration        | Recommendation/Comment                                                                                                                            |
|-----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
