...
![asav aws](_images/asav-aws-9.png)

![asav aws](_images/asav-aws-10.png)

Allocate an Elastic IP:

![asav aws](_images/asav-aws-7.png)

Associate the created Elastic IP to your public (outside) interface:

![asav aws](_images/asav-aws-8.png)
...
![asav aws s3](_images/asav-aws-s3-1.png)

![asav aws s3](_images/asav-aws-s3-2.png)

![asav aws s3](_images/asav-aws-s3-3.png)

![asav aws s3](_images/asav-aws-s3-4.png)

Modify the permission setting to allow a *Bucket Policy* (this could have been done in creating the bucket).

![asav aws s3](_images/asav-aws-s3-5.png)

Create the Bucket Policy:

![asav aws s3](_images/asav-aws-s3-6.png)
